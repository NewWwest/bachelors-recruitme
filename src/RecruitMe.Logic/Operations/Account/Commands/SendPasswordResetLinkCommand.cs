...
{
    public class SendPasswordResetLinkCommand : BaseAsyncOperation<OperationResult, string, EmailValidator>
    {
        ...
        protected override async Task<OperationResult> DoExecute(string request)
        {
